"""
run.py - Application Factory for Personal Website
-------------------------------------------------
...
- Can be run directly with `python run.py` for local development

Usage:
    $ flask run          # via Flask CLI
    OR
    $ python run.py      # runs on http://127.0.0.1:5000 by default
"""
